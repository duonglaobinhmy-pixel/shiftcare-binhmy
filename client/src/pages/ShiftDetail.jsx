...
const freshForm=()=>({clientRequestId:requestId(),entryMode:'QUICK',category:'HEALTH',eventType:'OBSERVATION',priority:'MEDIUM',occurredAt:new Date().toISOString().slice(0,16),content:'',intervention:'',requiresHandover:false,followUp:'',vitalConcern:false,bpSys:'',bpDia:'',pulse:'',spo2:'',temperature:'',respiratoryRate:'',bloodGlucose:'',insulinGiven:false,insulinOrderId:'',insulinDose:'',urgentConfirmed:false,urgentSymptoms:'',bowelStatus:'NORMAL',urineStatus:'NORMAL',urineDetail:'',note:'',woundImages:[]});
